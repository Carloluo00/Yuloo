...
class MainRuntimeTests(unittest.TestCase):
    def test_main_uses_s05_skill_loading_runtime_by_default(self):
        self.assertEqual(main.MODEL, s05_skill_loading.MODEL)
        self.assertEqual(main.agent_loop.__module__, s05_skill_loading.__name__)
