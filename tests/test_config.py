...
class ConfigTests(unittest.TestCase):
    def test_shared_config_is_exposed_through_runtime_modules(self):
        ...
        self.assertEqual(s03_todo_write.MODEL, config.S03_MODEL)
        self.assertEqual(s04_subagents.MODEL, config.S04_MODEL)
        self.assertEqual(tools.MODEL, config.SUBAGENT_MODEL)
